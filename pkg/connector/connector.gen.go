...
// Defines values for OrganizationSempV2AuthenticationApiKeyLocation.
const (
	OrganizationSempV2AuthenticationApiKeyLocationHeader OrganizationSempV2AuthenticationApiKeyLocation = "header"

	OrganizationSempV2AuthenticationApiKeyLocationQuery OrganizationSempV2AuthenticationApiKeyLocation = "query"
)

// Defines values for OrganizationSempV2AuthenticationAuthType.
const (
	OrganizationSempV2AuthenticationAuthTypeAPIKey OrganizationSempV2AuthenticationAuthType = "APIKey"

	OrganizationSempV2AuthenticationAuthTypeBasicAuth OrganizationSempV2AuthenticationAuthType = "BasicAuth"
)
...
type ClientInformation []struct {
	GuaranteedMessaging *struct {
		...
		Name *string `json:"name,omitempty"`
	} `json:"guaranteedMessaging,omitempty"`
}
...
type Organization struct {
	...
	SempV2Authentication *struct {
		ApiKeyLocation *OrganizationSempV2AuthenticationApiKeyLocation `json:"apiKeyLocation,omitempty"`

		// the name of the query parameter or HTTP header for submitting the API Key
		ApiKeyName *string                                  `json:"apiKeyName,omitempty"`
		AuthType   OrganizationSempV2AuthenticationAuthType `json:"authType"`
	} `json:"sempV2Authentication,omitempty"`
}

// OrganizationSempV2AuthenticationApiKeyLocation defines model for Organization.SempV2Authentication.ApiKeyLocation.
type OrganizationSempV2AuthenticationApiKeyLocation string

// OrganizationSempV2AuthenticationAuthType defines model for Organization.SempV2Authentication.AuthType.
type OrganizationSempV2AuthenticationAuthType string
